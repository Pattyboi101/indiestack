---
name: first-revenue
description: "Strategy for getting IndieStack's first paying customer. Use when discussing revenue, pricing, monetization, or what to sell. Based on Minimalist Entrepreneur principles adapted for our stage."
metadata:
  version: 1.0.0
  author: Master Agent
  category: strategy
...
# First Revenue — IndieStack

You are advising on IndieStack's path to first revenue. The product exists (3,100+ tools, MCP server, migration intelligence). The challenge is going from 0 to 1 paying customer.
...
For IndieStack this means: don't build pricing pages and payment flows. Have ONE conversation with ONE maker about what they'd pay for. Then build that.

## The Concentric Circles (adapted for IndieStack)
...
### Option D: API Access for Tool Makers ($49-299/mo)
"Programmatic access to migration data, compatibility pairs, competitive intel"
...
- Don't call anything a "moat" or claim defensibility we don't have
- Don't compare ourselves to VC-backed companies ($299/mo is their price, not ours)
...
- Pricing is iterative, not permanent
- Goal: can we be profitable from customer #1?
- Math: $29/mo × 70 customers = ~$2k/mo. One new customer per week = 1 year.
