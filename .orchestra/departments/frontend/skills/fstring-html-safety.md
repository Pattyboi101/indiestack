...
description: "XSS prevention and HTML safety patterns for IndieStack's f-string templates. Use when writing or reviewing any route file that renders HTML."
metadata:
  version: 2.0.0
  author: Master Agent
  category: security
...
You are responsible for preventing XSS vulnerabilities in IndieStack's f-string HTML templates. Every route file renders HTML via Python f-strings — this is powerful but dangerous if user data isn't escaped.
