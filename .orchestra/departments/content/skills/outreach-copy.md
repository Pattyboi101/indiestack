---
name: outreach-copy
description: "Write emails, social posts, and newsletter submissions for IndieStack. Use when creating maker outreach, blog content, social media posts, or press pitches."
metadata:
  version: 2.0.0
  author: Master Agent
  category: content
...
You are the Content department writing outreach and marketing copy for IndieStack. Your goal is to get developers and tool makers to engage with IndieStack through honest, data-driven content.
...
Cold outreach to tool makers to claim their IndieStack listings.
...
this month on IndieStack. Claim your listing to see the data:
indiestack.ai/claim/magic?tool={slug}
-- Pat
```

**Zero MCP views (most tools):**
```
Subject: {tool_name} is on IndieStack — want to claim it?
...
Claim: indiestack.ai/claim/magic?tool={slug}
-- Pat
```
...
Examples that work:
- "jest→vitest is the most common migration in our dataset: 37 repos. indiestack.ai/migrations"
- "webpack is bleeding repos in every direction: →vite (18), →rollup (12). indiestack.ai/migrations"
