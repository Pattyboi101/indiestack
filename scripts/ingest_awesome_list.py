...
SOURCES = {
    ...
    "go": {
        ...
        "description": "Go ecosystem tools (~2800 entries)",
        "category_map": {
            "authentication and oauth": "authentication", "bot building": "ai-dev-tools",
            "command line": "developer-tools", "continuous integration": "developer-tools",
            "database": "developer-tools", "database drivers": "developer-tools",
            "email": "email-marketing", "file handling": "file-management",
            "financial": "payments", "forms": "forms-surveys",
            "job scheduler": "scheduling-booking", "logging": "monitoring-uptime",
            "machine learning": "ai-dev-tools", "messaging": "customer-support",
            "natural language processing": "ai-dev-tools", "networking": "developer-tools",
            "orm": "developer-tools", "security": "authentication",
            "server applications": "developer-tools", "testing": "developer-tools",
            "third-party apis": "api-tools", "web frameworks": "developer-tools",
            "images": "design-creative", "search": "seo-tools",
        },
        "tool_pattern": r'^[*-]\s+\[([^\]]+)\]\(([^)]+)\)\s*[-–—:]\s*(.+)',
    },
    "rust": {
        "url": "https://raw.githubusercontent.com/rust-unofficial/awesome-rust/main/README.md",
        "description": "Rust ecosystem tools (~900 entries)",
        "category_map": {
            "applications": "developer-tools", "database": "developer-tools",
            "observability": "monitoring-uptime", "security tools": "authentication",
            "system tools": "developer-tools", "text processing": "developer-tools",
            "web": "developer-tools", "web servers": "developer-tools",
            "development tools": "developer-tools", "build system": "developer-tools",
            "testing": "developer-tools", "artificial intelligence": "ai-dev-tools",
            "authentication": "authentication", "caching": "developer-tools",
            "email": "email-marketing", "filesystem": "file-management",
            "finance": "payments", "logging": "monitoring-uptime",
            "machine learning": "ai-dev-tools", "network programming": "developer-tools",
            "search": "seo-tools", "template engine": "developer-tools",
            "data visualization": "analytics-metrics", "cryptography": "authentication",
        },
        "tool_pattern": r'^[*-]\s+\[([^\]]+)\]\(([^)]+)\)\s*[-–—:]\s*(.+)',
    },
    "nodejs": {
        "url": "https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/main/readme.md",
        "description": "Node.js tools and packages (~550 entries)",
        "category_map": {
            "http": "api-tools", "logging": "monitoring-uptime",
            "build tools": "developer-tools", "web frameworks": "developer-tools",
            "filesystem": "file-management", "image": "design-creative",
            "database": "developer-tools", "testing": "developer-tools",
            "security": "authentication", "authentication": "authentication",
            "authorization": "authentication", "email": "email-marketing",
            "natural language processing": "ai-dev-tools", "automation": "ai-automation",
            "static site generators": "landing-pages", "forum": "customer-support",
            "command-line apps": "developer-tools", "command-line utilities": "developer-tools",
            "debugging / profiling": "developer-tools", "templating": "developer-tools",
            "documentation": "developer-tools", "control flow": "developer-tools",
            "streams": "developer-tools", "real-time": "developer-tools",
            "text": "developer-tools", "data validation": "developer-tools",
            "parsing": "developer-tools", "compression": "developer-tools",
            "network": "developer-tools", "job queues": "developer-tools",
            "process management": "developer-tools", "serialization": "developer-tools",
        },
        "tool_pattern": r'^[*-]\s+\[([^\]]+)\]\(([^)]+)\)\s*[-–—:]\s*(.+)',
    },
    "docker": {
        "url": "https://raw.githubusercontent.com/veggiemonk/awesome-docker/master/README.md",
        "description": "Docker ecosystem tools (~500 entries)",
        "category_map": {
            "container operations": "developer-tools", "container composition": "developer-tools",
            "deployment and infrastructure": "developer-tools", "monitoring": "monitoring-uptime",
            "networking": "developer-tools", "orchestration": "developer-tools",
            "reverse proxy": "developer-tools", "security": "authentication",
            "volume management / data": "file-management", "user interface": "developer-tools",
            "cicd": "developer-tools", "development environment": "developer-tools",
            "serverless": "developer-tools", "testing": "developer-tools",
            "terminal": "developer-tools", "web": "developer-tools",
            "tools": "developer-tools", "builder": "developer-tools",
            "registry": "developer-tools", "logging": "monitoring-uptime",
        },
        "tool_pattern": r'^[*-]\s+\[([^\]]+)\]\(([^)]+)\)\s*(.+)',
    },
    "serverless": {
        "url": "https://raw.githubusercontent.com/anaibol/awesome-serverless/master/README.md",
        "description": "Serverless tools and platforms (~335 entries)",
        "category_map": {
            "general": "developer-tools", "platforms": "developer-tools",
            "frameworks": "developer-tools", "security": "authentication",
            "logging / monitoring": "monitoring-uptime", "testing": "developer-tools",
            "analytics": "analytics-metrics", "authentication": "authentication",
            "payments": "payments", "email": "email-marketing",
            "forms": "forms-surveys", "databases": "developer-tools",
            "scheduling": "scheduling-booking", "search": "seo-tools",
        },
        "tool_pattern": r'^[*-]\s+\[([^\]]+)\]\(([^)]+)\)\s*[-–—:]\s*(.+)',
    },
    "testing": {
        "url": "https://raw.githubusercontent.com/TheJambo/awesome-testing/master/README.md",
        "description": "Testing tools and resources (~136 entries)",
        "category_map": {
            "software": "developer-tools", "others": "developer-tools",
        },
        "tool_pattern": r'^[*-]\s+\[([^\]]+)\]\(([^)]+)\)\s*[-–—:]\s*(.+)',
    },
}
