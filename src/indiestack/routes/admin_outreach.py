            ...
            <td style="padding:8px;font-size:13px;">
                <form method="POST" action="/admin?tab=growth&section=email" style="display:inline;">
                    ...
                    <button type="submit"
                            ...
                            style="padding:4px 12px;font-size:12px;background:var(--slate);color:#000;border:none;border-radius:var(--radius-sm);font-weight:600;cursor:pointer;">
                        Send Winner Email
                    </button>
                </form>
            </td>
    ...
    <div style="display:flex;gap:10px;">
        ...
        <form method="POST" action="/admin?tab=growth&section=email">
            ...
            <button type="submit"
                    ...
                    style="padding:8px 16px;background:var(--slate);color:#000;border:none;border-radius:var(--radius-sm);font-size:13px;font-weight:700;cursor:pointer;">
    ...
    for m in sorted_makers:
        ...
        if maker_id in needs_stripe_ids and email:
            nudge += f''' <form method="POST" action="/admin" style="display:inline;"
                ...
                <button type="submit" class="btn btn-sm" style="background:var(--slate);color:#000;font-size:12px;padding:4px 10px;">
                    Stripe Nudge
                </button>
            </form>'''
