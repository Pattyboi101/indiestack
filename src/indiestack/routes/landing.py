...
async def landing(request: Request):
    ...
    hero = (
        ...
        '            <span style="color:rgba(255,255,255,0.85);">&#160;&#160;&#160;&#160;&#160;and 847 repos migrated to it last month.&rdquo;</span>'
        '        </div>'
        '    </div>'
        ...
        '        <a href="/analyze" class="btn btn-lg btn-primary landing-neon">'
        '            Scan Your Stack Free'
        '        </a>'
        '        <a href="/migrations" class="btn btn-lg btn-secondary">'
        '            View Migration Data'
        '        </a>'
        '    </div>'
    ...
    extra_head += (
        ...
        '  return{'
        '    glow:isDark?"0,212,245":"0,168,198",'
        ...
        '      var target=0;'
        '      if(dist<cellSize*0.7){target=c.glowAlpha;}'
        '      else if(dist<proximity){target=Math.max(0,(1-dist/proximity)*0.15);}'
        '      cells[idx]+=(target-cells[idx])*0.08;'
