...
NEED_MAPPINGS = {
    ...
    "aistandards": {"category": "ai-standards", "terms": ["llm benchmark", "ai benchmark", "model evaluation", "ai evals", "safety benchmark", "red teaming", "hallucination test", "model comparison", "eval harness"], "competitors": ["MMLU", "SWE-bench", "HellaSwag", "LMSYS Chatbot Arena", "TruthfulQA"], "title": "AI Standards & Benchmarks", "description": "LLM evaluation harnesses, safety benchmarks, and model comparison tools for testing AI systems.", "build_estimate": "varies", "icon": "\U0001f3af"},
...
_CAT_SYNONYMS: dict[str, str] = {
    ...
    "ai benchmark": "ai standards",     # bigram — "ai benchmark tool", "ai benchmark suite" → AI Standards & Specs
    "red teaming": "ai standards",      # bigram — "red teaming framework", "red teaming llm" → AI Standards & Specs
    "model comparison": "ai standards", # bigram — "model comparison tool", "model comparison leaderboard" → AI Standards & Specs
    "hallucination": "ai standards",    # "hallucination test", "hallucination benchmark", "reduce hallucination" → AI Standards & Specs
    "hallucinations": "ai standards",   # plural — "llm hallucinations", "detect hallucinations" → AI Standards & Specs
