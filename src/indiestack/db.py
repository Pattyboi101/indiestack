...
_CAT_SYNONYMS: dict[str, str] = {
    ...
    "payroll": "invoicing",     # "payroll api open source" → Invoicing & Billing
    ...
    # Search — "full text" bigram covers space-separated queries (3-token keys never fire)
    ...
    # Testing — "headless browser" bigram fires before "headless"→cms for browser automation queries
    "headless browser": "testing",  # bigram — "headless browser testing", "headless browser automation" → Testing Tools
    # AI — "article generation" bigram overrides "api"→api for content writing tool queries
    "article generation": "ai",     # bigram — "article generation tool", "article generation api" → AI & Automation
}
